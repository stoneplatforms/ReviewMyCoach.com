  ...
  return (
    <div className="min-h-screen bg-neutral-950">
      ...
      <div className="relative bg-neutral-950 text-neutral-200 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
          <div className="text-center">
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 tracking-tight">
              Find Your Perfect
              <br />
              <span className="bg-gradient-to-r from-neutral-100 via-neutral-400 to-neutral-200 bg-clip-text text-transparent">Coach</span>
            </h1>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          ...
          <div className="flex flex-wrap justify-center gap-3 text-sm mt-12">
            <span className="text-neutral-100 mr-2">Trending:</span>
            <Link href="/search?q=basketball" className="bg-neutral-800 text-neutral-100 px-4 py-2 rounded-full transition-all hover:scale-110 hover:shadow-2xl hover:shadow-black/30 border border-neutral-700">
              🏀 Basketball
            </Link>
            <Link href="/search?q=soccer" className="bg-neutral-800 text-neutral-100 px-4 py-2 rounded-full transition-all hover:scale-110 hover:shadow-2xl hover:shadow-black/30 border border-neutral-700">
              ⚽ Soccer
            </Link>
            <Link href="/search?q=tennis" className="bg-neutral-800 text-neutral-100 px-4 py-2 rounded-full transition-all hover:scale-110 hover:shadow-2xl hover:shadow-black/30 border border-neutral-700">
              🎾 Tennis
            </Link>
            <Link href="/search?q=swimming" className="bg-neutral-800 text-neutral-100 px-4 py-2 rounded-full transition-all hover:scale-110 hover:shadow-2xl hover:shadow-black/30 border border-neutral-700">
              🏊 Swimming
            </Link>
          </div>
        </div>
      ...
      <div className="bg-neutral-950 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-6 py-3 bg-neutral-800/40 border border-neutral-700 text-neutral-300 rounded-full text-sm font-medium mb-8 backdrop-blur-sm">Exclusive for Coaches</div>
            ...
            <div className="bg-gradient-to-br from-neutral-900 to-neutral-800 rounded-2xl p-8 border border-neutral-700">
              <div className="w-12 h-12 bg-neutral-700/50 rounded-xl flex items-center justify-center mb-6">
                <svg className="w-6 h-6 text-neutral-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                  </div>
              <h3 className="text-xl font-bold text-neutral-100 mb-4">Priority Placement</h3>
              <p className="text-neutral-400 mb-6">Get featured in search results and increase your visibility to potential clients by up to 300%.</p>
            ...
            <div className="bg-gradient-to-br from-neutral-900 to-neutral-800 rounded-2xl p-8 border border-neutral-700">
              ...
              <h3 className="text-xl font-bold text-neutral-100 mb-4">Advanced Analytics</h3>
              <p className="text-neutral-400 mb-6">Track your performance with detailed insights on profile views, bookings, and client engagement.</p>
              <div className="flex items-center text-neutral-300 text-sm font-medium">
                <span className="w-2 h-2 bg-neutral-400 rounded-full mr-2"></span>
                Deep Insights
                  </div>
            ...
            <div className="bg-gradient-to-br from-neutral-900 to-neutral-800 rounded-2xl p-8 border border-neutral-700">
              ...
              <h3 className="text-xl font-bold text-neutral-100 mb-4">Direct Payments</h3>
              <p className="text-neutral-400 mb-6">Accept payments directly through the platform with integrated Stripe processing and automated invoicing.</p>
              <div className="flex items-center text-neutral-300 text-sm font-medium">
                <span className="w-2 h-2 bg-neutral-400 rounded-full mr-2"></span>
          ...
          <div className="text-center">
                <Link 
              href="/subscription"
              className="inline-flex items-center px-8 py-4 bg-neutral-100 text-neutral-900 rounded-xl font-bold text-lg hover:bg-white transition-all duration-300 transform hover:scale-105 shadow-2xl shadow-black/20"
                >
              Upgrade to Pro
      ...
      <div className="bg-neutral-900 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-neutral-100 mb-4">How It Works</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-neutral-100 mb-4">Search & Discover</h3>
              <p className="text-neutral-400">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-neutral-100 mb-4">Connect & Book</h3>
              <p className="text-neutral-400">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-neutral-100 mb-4">Train & Improve</h3>
              <p className="text-neutral-400">
      ...
      <div className="bg-neutral-950 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/search"
              className="inline-flex items-center justify-center px-8 py-4 bg-neutral-100 text-neutral-900 rounded-xl font-bold text-lg hover:bg-white transition-all duration-300 transform hover:scale-105"
            >
              Find a Coach
              <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              href="/signup"
              className="inline-flex items-center justify-center px-8 py-4 border-2 border-neutral-300 text-neutral-200 rounded-xl font-bold text-lg hover:bg-neutral-100 hover:text-neutral-900 transition-all duration-300"
            >
              Join as Coach
              <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
