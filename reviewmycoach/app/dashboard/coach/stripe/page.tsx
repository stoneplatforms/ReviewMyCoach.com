        ...
        <div className="mb-6 bg-red-50 border border-red-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={handleRetry}
              disabled={retrying}
              className="inline-flex items-center px-3 py-1 border border-red-300 rounded-md text-sm font-medium text-red-700 bg-red-50 hover:bg-red-100 disabled:opacity-50"
            >
              {retrying ? (
                <>
        ...
        <div className="p-6">
          {fetchingAccount ? (
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Your Stripe account connection status</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-sm text-gray-900">{stripeAccount.email}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Country
                  </label>
                  <p className="text-sm text-gray-900">{stripeAccount.country}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Account ID
                  </label>
                  <p className="text-sm text-gray-900 font-mono">{stripeAccount.accountId}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Connected Since
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                {stripeAccount.status === 'requires_action' && (
                  <button
                    ...
                    disabled={connecting}
                    className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-opacity"
                  >
                    {connecting ? (
                      <>
            ...
            <div className="text-center py-8">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900">No Payment Account Connected</h3>
