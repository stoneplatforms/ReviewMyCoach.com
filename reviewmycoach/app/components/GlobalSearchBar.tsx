    ...
    <div ref={searchRef} className={`relative ${className}`}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 bg-gray-800 border border-gray-600 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-white placeholder-gray-400 transition-all duration-200"
          autoComplete="off"
        />
        {loading && (
              ...
              {suggestions.map((suggestion, index) => (
                <button
                  ...
                  className={`w-full px-4 py-3 text-left hover:bg-gray-700 flex items-center space-x-3 transition-colors ${
                    index === selectedIndex ? 'bg-gray-700 border-l-2 border-orange-500' : ''
                  }`}
                >
              ...
              {searchTerm.trim() && (
                <>
                  ...
                  <button
                    ...
                    className="w-full px-4 py-3 text-left hover:bg-gray-700 flex items-center space-x-3 transition-colors text-orange-400"
                  >
